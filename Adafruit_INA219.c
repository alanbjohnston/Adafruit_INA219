...
void setCalibration_32V_2A(int fd) {
  ...
  wireWriteRegister(fd, INA219_REG_CONFIG, config);
}
...
void setCalibration_16V_400mA(int fd) {
  ...
  // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 40;  // changed from 20 due to differences    // Current LSB = 50uA per bit (1000/50 = 20)
